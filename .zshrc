...
export IDEA="$HOME/idea-IU-231.9392.1/bin/"
...
plugins=(git aliases archlinux zsh-syntax-highlighting zsh-autosuggestions command-not-found extract sudo)
...
alias nxinit='nvim ~/.xinitrc'
alias ndunst='nvim ~/.config/dunst/dunstrc'
alias nzsh='nvim ~/.zshrc'
alias nkitty='nvim ~/.config/kitty/kitty.conf'
alias nastro='nvim ~/.config/nvim/lua/user/'
